...
class TestStudent(TestCase):
    ...
    def test_enroll_in_new_course_without_third_param_adds_notes_no_the_course(self):
    ...
    def test_enroll_in_new_course_wit_Y_as_third_param_adds_notes_no_the_course(self):
        result = self.student.enroll(
            'math',
            ['x + y = z'],
            'Y'
    ...
    def test_enroll_with_different_third_param_does_not_add_notes_no_the_course(self):
        result = self.student.enroll(
            'math',
            ['x + y = z'],
            'n'
